...
export const TILE_DEFINITIONS: Record<string, BaseTileDefinition> = {
  ...
  "water-topLeft": {
    ...
    type: "overflow",
    textureUrl: "/tilesets/terrain/water/water_topLeft.png",
    tileSize: 32,
  },
  "water-topRight": {
    id: "water-topRight",
    ...
    type: "overflow",
    textureUrl: "/tilesets/terrain/water/water_topRight.png",
    tileSize: 32,
  },
  "water-bottomLeft": {
    id: "water-bottomLeft",
    ...
    type: "overflow",
    textureUrl: "/tilesets/terrain/water/water_bottomLeft.png",
    tileSize: 32,
  },
  "water-bottomRight": {
    ...
    type: "overflow",
    textureUrl: "/tilesets/terrain/water/water_bottomRight.png",
    tileSize: 32,
  },
  "sand-terrain": {
    id: "sand-terrain",
